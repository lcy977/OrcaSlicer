...
void MainFrame::init_tabpanel() {
    ...
    //m_project = new ProjectPanel(m_tabpanel, wxID_ANY, wxDefaultPosition, wxDefaultSize);//modify lcy12.27
...
static wxMenu* generate_help_menu()
{
    ...
    //append_menu_item(helpMenu, wxID_ANY, _L("Setup Wizard"), _L("Setup Wizard"), [](wxCommandEvent &) {wxGetApp().ShowUserGuide();});//modify lcy12.27
...
//    });
    ...
    //m_topbar->AddDropDownSubMenu(helpMenu, _L("Help"));//modify lcy12.27
